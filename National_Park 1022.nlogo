globals [
  ...
  tourists-in-each-iteration   ;; number of tourists visted in each iteration
  tourists-add-wave            ;;
  cleaner-wage                 ;; hourly wage of cleaners

  park-attraction-level        ;; attraction-level of the park
  revenue                      ;; revenue earned by the park
...
to setup
  ...
  ;; strategy is open-clean or mixed-clean
  ...
  [
    ...
    [
      ...
      [
        ...
        [
          set attraction? true
          ask n-of 8 neighbors     ;; set its neighbors as attractions
          [
            set attraction? true
          ]
...
to update-cleaners
  ...
  [
    ...
    [
      ...
      let found? false
      let d 3           ;; the farthest distance that cleaners can clean
      ...
      [
        ...
        ;; under open-clean strategy or mixed-clean strategy
  ...
  set revenue revenue - number-of-cleaners * hourly-wages    ;; caculate revenue
end
